<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="home.php">Serenity Healthcare Centre</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            if (isset($_SESSION["id"]) && !empty($_SESSION["id"])) {
                ...
                echo '<li class="nav-item"><a class="nav-link" href="view_tests.php">Tests</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="view_bills.php">Bills</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="add_complaint.php">Complaints</a></li>';
